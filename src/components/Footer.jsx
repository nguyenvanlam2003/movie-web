            ...
            <div className="mx-auto grid gap-[60px] sm:grid-cols-2 lg:max-w-screen-xl lg:grid-cols-footer">
                ...
                <div>
                    ...
                    <ul className="mt-4">
                        ...
                        <li>
                            <a href="/cartoon" className="inline-block py-1 hover:text-[#0071dc]">
                                Phim hoạt hình
                            </a>
                        </li>
                        <li>
                            <a href="/tv" className="inline-block py-1 hover:text-[#0071dc]">
                                Phim bộ
                            </a>
                        </li>
                        <li>
                            <a href="/movie" className="inline-block py-1 hover:text-[#0071dc]">
                                Phim lẻ
                            </a>
                        </li>
                    </ul>

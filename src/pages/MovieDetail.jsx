            ...
            {isLoading ? (
                ...
                <div className="mx-auto max-w-screen-xl">
                    ...
                    <div className="mt-3 space-y-2 text-base text-white lg:text-lg">
                        <h1 className="text-2xl font-bold lg:text-3xl">Phim: {movieInfo?.name}</h1>
                        ...
                        <div className="flex gap-2">
                            ...
                            <p>{(movieInfo?.category || []).map((genre) => genre.name).join(", ")}</p>
                        </div>
                        <div className="flex gap-2">
                        ...
                        <div className="flex gap-2">
                            <p className="flex-shrink-0 font-medium">Đạo diễn:</p>
                            <p>{(movieInfo?.director || []).join(", ")}</p>
                        </div>
                        <div className="flex gap-2">
                            <p className="flex-shrink-0 font-medium">Diễn viên:</p>
